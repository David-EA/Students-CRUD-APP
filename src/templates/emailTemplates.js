const emailTemplates = {
  ...
  welcomeTemplate: (name, emailToken, baseUrl = 'http://localhost:3000') => {
    return {
      subject: 'Welcome to the Student Management System - Please Verify Your Email',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            ...
            <div class="content">
                <h2>Hello ${name}!</h2>
                <p>Thank you for signing up with our Student Manangement Service. We're excited to have you on board!</p>
            ...
            <div class="footer">
                <p>Best regards,<br>The Student Management System Team</p>
        ...
        <body>
            ...
            <div class="content">
                ...
                <div class="success-box">
                    ...
                    <p>Your Student Management Service account is now fully activated and ready to use.</p>
                </div>
                ...
                <p>Thank you for choosing  Student Management System. We look forward to serving you!</p>
            </div>
            <div class="footer">
                <p>Best regards,<br>The Student Management System Team</p>
            </div>
